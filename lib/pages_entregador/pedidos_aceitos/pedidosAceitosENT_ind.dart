...
import 'pedidoAceitosENT_api.dart';

class PedidosAceitosENTind extends StatefulWidget {
  final int entId;
  final String status;
  final Function() atualizarPedidos;

  PedidosAceitosENTind({
    Key? key,
    required this.entId,
  ...
  @override
  _PedidosAceitosENTindState createState() => _PedidosAceitosENTindState();
}

class _PedidosAceitosENTindState extends State<PedidosAceitosENTind> {
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          widget.status == 'Aceito'
                              ? ElevatedButton(
                                  onPressed: () async {
                                    final classe = PedidosAceitosENTapi();
                                    final bool? pedidoEncerrado =
                                        await classe.PedidoRealizado(
                                            widget.entId);
                                    if (pedidoEncerrado == true) {
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        const SnackBar(
                                          content:
                                              Text('O pedido já está entregue'),
